...
import { MessagePayload } from "../../iframe-service/src/iframe-service";
...
async function messageParent(payload: MessagePayload) {
    ...
    return new Promise<MessagePayload["data"]>((resolve) => {
        ...
        // listening.
        let listener = (e: MessageEvent<MessagePayload>) => {
            const { data } = e;
